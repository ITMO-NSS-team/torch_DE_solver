...
import numpy as np
'''
Functions here serve to make all possible forms of input into an inner repre
sentation of solver
'''
...
def grid_prepare(grid):
    ...
    inner and boundaty points. This one is axilluary function that allow to
    reorder grid nodes with respect to the point types - innner points first
    then bounary points of different types
