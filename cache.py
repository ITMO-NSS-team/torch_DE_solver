...
class Model_prepare():
    ...
    def cache_lookup(self, lambda_bound=0.001, weak_form=None,
                     cache_dir='../cache/', nmodels=None, cache_verbose=False):
    ...
    def save_model(self, prep_model, state, optimizer_state,
                   cache_dir='../cache/', name=None):
        if name == None:
    ...
    def cache_nn(self, cache_dir, nmodels, lambda_bound, cache_verbose,
              model_randomize_parameter, cache_model, weak_form):
    ...
    def cache_mat(self, cache_dir, nmodels, lambda_bound, cache_verbose,
              model_randomize_parameter, cache_model, weak_form):
    ...
    def cache(self, cache_dir, nmodels, lambda_bound, cache_verbose,
              model_randomize_parameter, cache_model, weak_form=None):
