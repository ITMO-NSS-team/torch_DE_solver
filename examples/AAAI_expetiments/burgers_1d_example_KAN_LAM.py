...
def experiment_data_amount_burgers_1d_lam_KAN(grid_res,exp_name='burgers1d_lam_KAN',save_plot=True):
...
if __name__ == '__main__':
    ...
    for grid_res in range(10, 101, 10):
        for _ in range(nruns):
            ...
            df.to_csv('examples\\AAAI_expetiments\\results\\burgers_lam_KAN_{}.csv'.format(grid_res))
