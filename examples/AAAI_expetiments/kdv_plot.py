...
df_pinn = pd.read_csv('examples\\AAAI_expetiments\\results\\kdv_PINN.csv')
df_PSO = pd.read_csv('examples\\AAAI_expetiments\\results\\kdv_PSO.csv')
df_lam = pd.read_csv('examples\\AAAI_expetiments\\results\\kdv_lam.csv')
df_F = pd.read_csv('examples\\AAAI_expetiments\\results\\kdv_fourier.csv')
df_natg = pd.read_csv('examples\\AAAI_expetiments\\results\\kdv_NGD.csv')
df_kan_PINN = pd.read_csv('examples\\AAAI_expetiments\\results\\kdv_PINN_KAN.csv')
df_kan_PSO = pd.read_csv('examples\\AAAI_expetiments\\results\\kdv_PSO_KAN.csv')
df_KAN_lam = pd.read_csv('examples\\AAAI_expetiments\\results\\kdv_lam_KAN.csv')
