...
datapath = "../../PINNacle_data/ns2d.dat"
...
for grid_res in range(20, 201, 20):
    for _ in range(nruns):
        list_u, list_v, list_p = navier_stokes_2d_classic_experiment(grid_res)
...
df_u.to_csv('examples/benchmarking_data/navier_stokes_2d_classic_experiment_20_200_cache_u_func={}.csv'
            .format(str(True)))
df_v.to_csv('examples/benchmarking_data/navier_stokes_2d_classic_experiment_20_200_cache_v_func={}.csv'
            .format(str(True)))
df_p.to_csv('examples/benchmarking_data/navier_stokes_2d_classic_experiment_20_200_cache_p_func={}.csv'
            .format(str(True)))
