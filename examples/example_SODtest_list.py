...
bnd1_0 = torch.cartesian_prod(x, torch.from_numpy(np.array([0], dtype=np.float64))).float()
bnd1_1 = torch.cartesian_prod(x, torch.from_numpy(np.array([0], dtype=np.float64))).float()
bnd1_2 = torch.cartesian_prod(x, torch.from_numpy(np.array([0], dtype=np.float64))).float()

bnd1 = [bnd1_0,bnd1_1,bnd1_2]

u_init0 = np.zeros(bnd1_0.shape[0], dtype=np.float64)
u_init1 = np.zeros(bnd1_1.shape[0], dtype=np.float64)
u_init2 = np.zeros(bnd1_2.shape[0], dtype=np.float64)
j=0
for i in bnd1_0:
...
bndval1 = [bndval1_0,bndval1_1,bndval1_2]

#  Boundary conditions at x=0
bnd2_0 = torch.cartesian_prod(torch.from_numpy(np.array([0], dtype=np.float64)), t).float()
bnd2_1 = torch.cartesian_prod(torch.from_numpy(np.array([0], dtype=np.float64)), t).float()
bnd2_2 = torch.cartesian_prod(torch.from_numpy(np.array([0], dtype=np.float64)), t).float()

bnd2 = [bnd2_0,bnd2_1,bnd2_2]

bndval2_0 = torch.from_numpy(np.asarray([p_l for i in bnd2_0[:, 0]], dtype=np.float64))
bndval2_1 = torch.from_numpy(np.asarray([v_l for i in bnd2_1[:, 0]], dtype=np.float64))
bndval2_2 = torch.from_numpy(np.asarray([Ro_l for i in bnd2_2[:, 0]], dtype=np.float64))

bndval2 = [bndval2_0, bndval2_1, bndval2_2]


# Boundary conditions at x=1
bnd3_0 = torch.cartesian_prod(torch.from_numpy(np.array([1], dtype=np.float64)), t).float()
bnd3_1 = torch.cartesian_prod(torch.from_numpy(np.array([1], dtype=np.float64)), t).float()
bnd3_2 = torch.cartesian_prod(torch.from_numpy(np.array([1], dtype=np.float64)), t).float()

bnd3 = [bnd3_0,bnd3_1,bnd3_2]

# u(1,t)=0
bndval3_0 = torch.from_numpy(np.asarray([p_r for i in bnd3_0[:, 0]], dtype=np.float64))
bndval3_1 = torch.from_numpy(np.asarray([v_r for i in bnd3_1[:, 0]], dtype=np.float64))
bndval3_2 = torch.from_numpy(np.asarray([Ro_r for i in bnd3_2[:, 0]], dtype=np.float64))
bndval3 = [bndval3_0, bndval3_1, bndval3_2]
