...
data_file = os.path.abspath(os.path.join(os.path.dirname(__file__), "../PINNacle_data/ns_0_obstacle.npy"))
...
def navier_stokes_2d_back_step_flow_experiment(grid_res):
    ...
    model.train(optimizer, 2e4, save_model=True, callbacks=[cb_es, cb_plots])
    ...
    exact_u, exact_v, exact_p = exact_solution_data(grid, data_file, pde_dim_in, pde_dim_out)
...
df_u.to_csv('examples/benchmarking_data/navier_stokes_2d_back_step_flow_experiment_100_200_cache_u_func={}.csv'
            .format(str(True)))
df_v.to_csv('examples/benchmarking_data/navier_stokes_2d_back_step_flow_experiment_100_200_cache_v_func={}.csv'
            .format(str(True)))
df_p.to_csv('examples/benchmarking_data/navier_stokes_2d_back_step_flow_experiment_100_200_cache_p_func={}.csv'
            .format(str(True)))
